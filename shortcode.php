            ...
            if ($post) {
                ...
                if ($layout == "grid" || $layout == "list") {
                    ...
                    if ($img) {
                        ...
                        $inner .= get_diver_thumb_id_img($post->ID, apply_filters('diver_widget_scArticle_post_thumb', 'medium'));
                        if ($cat_name) {
...
function diver_relpost($atts, $content = null)
{
    ...
    foreach ($ids as $id) {
        if ($id) {
            $html .= '<li><a href="' . get_permalink($id) . '" title="' . get_the_title($id) . '">' . get_the_title($id) . '</a></li>';
        }
    }
    $html .= '</ul></div>';
